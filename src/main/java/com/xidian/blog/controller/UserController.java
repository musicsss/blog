...
//
//    @Autowired
//    public UserController(UserService userService,VerifyService verifyService,ArticleService articleService){
...
//    }
//
//    @PostMapping("/findUserInformation")
//    public String getUserInformation(HttpSession httpSession){
//        DataMap dataMap = userService.findUserByUserName(httpSession.getAttribute("loginUser").toString());
...
//        userEntity.setEmailAddress(request.get("emailAddress").toString());
//
...
//        }
//        DataMap<UserEntity> result = userService.findUserByEmailAddress(userEntity.getEmailAddress());
//        if(result.getCode() == 0){
...
//            userEntity.setPassWord(new Md5PasswordEncoder().encodePassword("testUser"+i,null));
...
//            articleEntity.setArticleTitle("test article title"+i);
//            articleEntity.setArticleMasterId(i);
//            articleEntity.setArticleCreateTime(new Date());
//            articleEntity.setArticleContent("test article content"+i);
//            articleEntity.setArticleInfo("test article info"+i);
//            articleService.addArticle(articleEntity);
//            System.out.println("新增"+i+"完成");
//        }
